            ...
            difference(){
                ...
                union(){//1" strap slots
                    translate([(radius+2)*-1,0,1]){//front slot
                        ...
                        translate([0,-13,1.17]){cylinder(r1=1,r2=2,h=1,center=true);}//right end bevel
                        translate([0,13,1.17]){cylinder(r1=1,r2=2,h=1,center=true);}//left end bevel
                        //bottom bevels
                        translate([0,0,-2]){rotate([0,45,0]){cube([4,26,4],true);}}//slot bevel
                        translate([0,-13,-.67]){cylinder(r1=2,r2=1,h=1,center=true);}//right end bevel
                        translate([0,13,-.67]){cylinder(r1=2,r2=1,h=1,center=true);}//left end bevel
                    }
...
module makeRetainer(diameter,height,base,lipHeight,partGap) {
    ...
    difference(){
        ...
        // inner cutout
        translate([0,0,height-lipHeight-5.1]){cylinder(r=innerRadius,h=height+1,center=false);}    // button hole through top
